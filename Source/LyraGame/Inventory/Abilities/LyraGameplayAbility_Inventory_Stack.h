...
#include "LyraGameplayAbility_Inventory_Stack.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class ULyraGameplayAbility_Inventory_Stack : public ULyraXCLGameplayAbilityClientToServer
{
	GENERATED_BODY()

public:
	UE_API ULyraGameplayAbility_Inventory_Stack(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
