...
#include "LyraGameplayAbility_Inventory_Drop.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class ULyraGameplayAbility_Inventory_Drop : public ULyraXCLGameplayAbilityClientToServer
{
	GENERATED_BODY()

public:
	ULyraGameplayAbility_Inventory_Drop(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
