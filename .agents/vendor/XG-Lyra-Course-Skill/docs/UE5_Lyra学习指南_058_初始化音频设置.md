...
- [UE5\_Lyra学习指南\_058\_初始化音频设置](#ue5_lyra学习指南_058_初始化音频设置)
	- [概述](#概述)
	- [代码](#代码)
	- [总结](#总结)
...
一定要记得去/Game/UI/Settings/GameSettingRegistryVisuals.GameSettingRegistryVisuals这里配置实例化的控件类
## 代码
``` cpp
...
## 总结
本节主要是为了保证文档连贯性,无实际笔记,部分演示内容看视频配置即可.